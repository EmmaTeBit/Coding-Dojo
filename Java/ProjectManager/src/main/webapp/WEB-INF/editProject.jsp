...
<div class=" py-5 d-flex justify-content-center">
	<div class="card shadow-2-strong card-registration p-md-5 m-4" style="border-radius: 15px;">
		<div class="card-body p-4 p-md-55">
			<h1 class="text-center h1 fw-bold">Edit Project</h1>
			
			<form:form action="/projects/edit/${project.id}" modelAttribute="project" class="form" method="post">
		
			<div class="form-row">
				<form:label for="title" path="title">Project Title:</form:label>
