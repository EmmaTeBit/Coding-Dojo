...
class Burger:
    def __init__(self,data):
        ...
        # We now create a list so that later we can 
        # add in all the topping objects that relate to a burger.
        self.toppings = []
    ...
    def get_burger_with_toppings( cls , data ):
        ...
        for row_from_db in results:
            ...
            }# This is where the Burger class is dependent on the Topping class
            burger.toppings.append( topping.Topping( topping_data ) )
        return burger
